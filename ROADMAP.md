...
| 3 | Incremental local GraphRAG (deterministic-first, two-tier; venue-anchored multi-hop) | **In progress** — deterministic tier done + gated (multi-hop 2.5–3× BM25), ledger-wired, RAM-budgeted; LLM tier measured via oracle = *not earned* (live-LLM deferred) ([`STAGE_3.md`](kortex/specs/STAGE_3.md)) |
