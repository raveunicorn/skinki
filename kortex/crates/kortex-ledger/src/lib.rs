...
//! the project's answer (see `kortex/specs/DERIVATION_LEDGER.md`): store the
...
//!   `kortex-store`'s `content_hash_128` for conceptual consistency).
...
//! append-only log, exactly the shape `kortex-store` already durably persists,
...
// ---------------------------------------------------------------------------
// Content hashing — 128-bit, dual-seed FNV-1a (mirrors kortex-store)
// ---------------------------------------------------------------------------
